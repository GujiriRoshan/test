		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Processors </button>
				</div> 				
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Add Processors</h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="categoriesName" class="col-sm-4 control-label">Processor Type: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="categoriesName" placeholder="Processor Type" name="categoriesName" autocomplete="off">
				    </div>
	        </div>        	        
	        <div class="form-group">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
		      	<div class="form-group">
		        	<label for="editCategoriesName" class="col-sm-4 control-label">Processor Type: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
